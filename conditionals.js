...
// ==========================================
const smallerNumber = 10 > 20;
console.log("Is 10 groter dan 20?" , smallerNumber);
...
// ==========================================
const unequalNumber = 10 !== 11;
console.log("Is 10 ongelijk aan 11?" , unequalNumber);
// ==========================================
// 3. Declareer een variabele en sla daar in op of de woorden 'zoet' en 'sappig' hetzelfde zijn                // geeft false wanneer gelogd
// ==========================================
const sweetAndJuicy = "zoet" === "sappig";
console.log (sweetAndJuicy);
// ==========================================
...
if ((!isRaining) && (temperature > 21)) {
    console.log("Je kunt korte broek aan!");
}
